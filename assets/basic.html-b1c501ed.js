...
const add = (a, b) =&gt; a+b;
\`\`\`
</code></pre><h2 id="events-in-javascript" tabindex="-1"><a class="header-anchor" href="#events-in-javascript" aria-hidden="true">#</a> Events in JavaScript</h2><p>Events: click, mouse over, keydown, and change, addEventListener demo</p><pre><code>\`\`\`javascript
// addEventListener
