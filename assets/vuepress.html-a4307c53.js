...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul></li></ol><h3 id="其他特别用法" tabindex="-1"><a class="header-anchor" href="#其他特别用法" aria-hidden="true">#</a> 其他特别用法</h3>`,10),v=n("li",null,[n("p",null,[n("code",null,".vuepress/public"),s("下的附件, 在markdown中可以使用相对路径, "),n("code",null,"/images/django_01.png")])],-1),k=n("p",null,[s("所有目录下必须有"),n("code",null,"README.md"),s(", 才能正常访问")],-1),m=n("code",null,"docs/python/README.md",-1),b={href:"https://domain.com/python/",target:"_blank",rel:"noopener noreferrer"},h=a(`<li><p>markdown引用, 同一目录下直接引用<code>python.md</code>, 或者按目录关系</p></li><li><p>在首页使用如下标签</p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code><span class="token front-matter-block"><span class="token punctuation">---</span>
            ...
            <span class="token key atrule">steps</span><span class="token punctuation">:</span>
                ...
                <span class="token punctuation">-</span> <span class="token key atrule">name</span><span class="token punctuation">:</span> Deploy Docs
                    ...
                    <span class="token key atrule">with</span><span class="token punctuation">:</span>
                        ...
                        <span class="token key atrule">repository-name</span><span class="token punctuation">:</span> maxiaoteng001/notebook_by_vuepress
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul>`,1);function E(q,w){const e=c("ExternalLinkIcon");return p(),o("div",null,[d,i(" more "),r,n("ol",null,[v,n("li",null,[k,n("ul",null,[n("li",null,[m,s(", url: "),n("a",b,[s("https://domain.com/python/"),t(e)])])])]),h]),g,n("ol",null,[n("li",null,[n("p",null,[s("脚本参考pub_github.sh, "),n("a",y,[s("参考文档"),t(e)])])]),_,n("li",null,[n("p",null,[s("使用github action发布, 参考"),n("a",f,[s("github-pages-deploy-action"),t(e)])]),x])])])}const D=l(u,[["render",E],["__file","vuepress.html.vue"]]);export{D as default};
